...
lib.ssMetadata = [
		{name:"300x600_atlas_", frames: [[0,0,300,380],[302,0,170,310]]}
];
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_2.setTransform(98.9,559.3,0.811,0.811,0,0,0,101.6,26.9);
	...
	this.instance_6.setTransform(83.7,412.1,1.09,1.09,0,0,0,184,28.2);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(27).to({_off:false},0).wait(1).to({regX:206.6,regY:29.5,x:108.3,y:413.5,alpha:0.125},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.375},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.625},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.875},0).wait(1).to({alpha:1},0).wait(48).to({alpha:0.875},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.625},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.375},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.125},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(204));
...
p.nominalBounds = new cjs.Rectangle(149,297,303,604.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"img/bj.jpg?1568879623190", id:"300x600_atlas_"}
	],
	preloads: []
};
