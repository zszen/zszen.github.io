...
(lib.t2swf = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D81E05").s().p("");
	this.shape.setTransform(62.7,-5.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D81E05").s().p("");
	this.shape_1.setTransform(20.1,-5.7);
...
p.nominalBounds = new cjs.Rectangle(-3.7,-29.5,175,91.5);
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1705));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1705));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(874).to({_off:false},0).to({alpha:1},6).wait(825));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(874).to({_off:false},0).to({alpha:1},6).wait(825));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(854).to({_off:false},0).to({alpha:1},6).wait(845));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(791).to({_off:false},0).to({alpha:1},8).wait(49).to({y:402.3},6).wait(851));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(714).to({_off:false},0).to({alpha:1},7).wait(64).to({alpha:0},6).to({_off:true},1).wait(913));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(663).to({_off:false},0).to({alpha:1},7).wait(37).to({startPosition:0},0).to({alpha:0},7).wait(991));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(645).to({_off:false},0).to({scaleY:1.1,y:490,alpha:1},6).wait(197).to({scaleY:1.3,y:470.5},6).wait(851));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(640).to({_off:false},0).to({regY:294.6,scaleX:1.02,scaleY:1.02,x:86.1,y:301.8},51,cjs.Ease.get(1)).wait(1014));

	// t7
	this.instance_9 = new lib.VektorSmartobjekt2swf("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(101.1,11.7,0.713,0.713,0,0,0,74.5,7.9);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(554).to({_off:false},0).to({alpha:1},6).to({_off:true},80).wait(1065));

	// t5
	this.instance_10 = new lib.VektorSmartobjektswf("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(79.3,568.9,0.601,0.601,0,0,0,100.9,26.7);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(554).to({_off:false},0).to({alpha:1},6).to({_off:true},80).wait(1065));

	// t4
	this.instance_11 = new lib.yuding();
	this.instance_11.parent = this;
	this.instance_11.setTransform(79.5,484.2,0.562,0.562,0,0,0,115.2,28.6);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;
	new cjs.ButtonHelper(this.instance_11, 0, 1, 2, false, new lib.yuding(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(534).to({_off:false},0).to({alpha:1},6).to({_off:true},100).wait(1065));

	// t2
	this.instance_12 = new lib.t2swf2();
	this.instance_12.parent = this;
	this.instance_12.setTransform(98.2,439.3,0.904,0.904,0,0,0,88.4,19.2);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(471).to({_off:false},0).to({alpha:1},8).wait(49).to({y:402.3},6).to({_off:true},106).wait(1065));

	// t2
	this.instance_13 = new lib.t2swf();
	this.instance_13.parent = this;
	this.instance_13.setTransform(98.2,439.3,0.904,0.904,0,0,0,88.4,19.2);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(394).to({_off:false},0).to({alpha:1},7).wait(64).to({alpha:0},6).to({_off:true},1).wait(1233));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(343).to({_off:false},0).to({alpha:1},7).wait(37).to({startPosition:0},0).to({alpha:0},7).to({_off:true},246).wait(1065));

	// baidi
	this.instance_15 = new lib.baiidi();
	this.instance_15.parent = this;
	this.instance_15.setTransform(80,500,1,1,0,0,0,80,100);
	this.instance_15.alpha = 0;
	this.instance_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(325).to({_off:false},0).to({scaleY:1.1,y:490,alpha:1},6).wait(197).to({scaleY:1.3,y:470.5},6).to({_off:true},106).wait(1065));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(320).to({_off:false},0).to({regY:294.6,scaleX:1.02,scaleY:1.02,x:86.1,y:301.8},51,cjs.Ease.get(1)).to({_off:true},269).wait(1065));

	// t7
	this.instance_17 = new lib.VektorSmartobjekt2swf("synched",0);
	this.instance_17.parent = this;
	this.instance_17.setTransform(101.1,11.7,0.713,0.713,0,0,0,74.5,7.9);
	this.instance_17.alpha = 0;
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(234).to({_off:false},0).to({alpha:1},6).to({_off:true},80).wait(1385));

	// t5
	this.instance_18 = new lib.VektorSmartobjektswf("synched",0);
	this.instance_18.parent = this;
	this.instance_18.setTransform(79.3,568.9,0.601,0.601,0,0,0,100.9,26.7);
	this.instance_18.alpha = 0;
	this.instance_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(234).to({_off:false},0).to({alpha:1},6).to({_off:true},80).wait(1385));

	// t4
	this.instance_19 = new lib.yuding();
	this.instance_19.parent = this;
	this.instance_19.setTransform(79.5,484.2,0.562,0.562,0,0,0,115.2,28.6);
	this.instance_19.alpha = 0;
	this.instance_19._off = true;
	new cjs.ButtonHelper(this.instance_19, 0, 1, 2, false, new lib.yuding(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(214).to({_off:false},0).to({alpha:1},6).to({_off:true},100).wait(1385));

	// t2
	this.instance_20 = new lib.t2swf2();
	this.instance_20.parent = this;
	this.instance_20.setTransform(98.2,439.3,0.904,0.904,0,0,0,88.4,19.2);
	this.instance_20.alpha = 0;
	this.instance_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(151).to({_off:false},0).to({alpha:1},8).wait(49).to({y:402.3},6).to({_off:true},106).wait(1385));

	// t2
	this.instance_21 = new lib.t2swf();
	this.instance_21.parent = this;
	this.instance_21.setTransform(98.2,439.3,0.904,0.904,0,0,0,88.4,19.2);
	this.instance_21.alpha = 0;
	this.instance_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(74).to({_off:false},0).to({alpha:1},7).wait(64).to({alpha:0},6).to({_off:true},1).wait(1553));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(23).to({_off:false},0).to({alpha:1},7).wait(37).to({startPosition:0},0).to({alpha:0},7).to({_off:true},246).wait(1385));

	// baidi
	this.instance_23 = new lib.baiidi();
	this.instance_23.parent = this;
	this.instance_23.setTransform(80,500,1,1,0,0,0,80,100);
	this.instance_23.alpha = 0;
	this.instance_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(5).to({_off:false},0).to({scaleY:1.1,y:490,alpha:1},6).wait(197).to({scaleY:1.3,y:470.5},6).to({_off:true},106).wait(1385));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_24).to({regY:294.6,scaleX:1.02,scaleY:1.02,x:86.1,y:301.8},51,cjs.Ease.get(1)).to({_off:true},269).wait(1385));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(68.5,258.5,290.7,1090.1);
// library properties:
lib.properties = {
	id: '31884912B94D4461B9580D28E2A653B8',
	width: 160,
	height: 600,
	fps: 25,
	color: "#FFFFFF",
...
an.compositions['31884912B94D4461B9580D28E2A653B8'] = {
