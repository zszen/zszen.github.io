...
lib.ssMetadata = [
		{name:"160x600_atlas_", frames: [[0,0,160,600],[0,602,8,16]]}
];
...
(lib.小标_1 = function(mode,startPosition,loop) {
	...
	this.button_1.setTransform(3.6,10.8,1,1,0,0,0,10.2,13);
	...
	this.button_2.setTransform(-60.6,2.2,7.829,1.654,0,0,0,9.9,12.9);
	...
	// 图层 4
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("As4D7IAAn1IZxAAIAAH1g");
	this.shape_10.setTransform(-54.8,0);
...
p.nominalBounds = new cjs.Rectangle(-6.6,-2.2,20.5,26);
...
(lib.t2swf = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D81E05").s().p("");
	this.shape.setTransform(128.7,48);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D81E05").s().p("");
	this.shape_1.setTransform(116.6,48.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#D81E05").s().p("");
	this.shape_2.setTransform(128.2,33.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#D81E05").s().p("AgzAnQARgIAHgMQAFgJAAgTIgPAAIgNABIAAgNIANAAIBLAAIANAAIAAANIgNgBIgUAAIAAAoQAAAFAJgBQALAAAAgEIACgQQAGAEAGAAQgBAUgEADQgBAFgVAAQgNAAgDgDQgDgBAAgGIAAguIgPAAQAAAVgHAOQgFAKgJAHIgMAHQgEgHgFgEgAAcgkIg3AAIgLABIAAgOIALABIA3AAIALgBIAAAOIgLgBg");
	this.shape_3.setTransform(117,34.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#D81E05").s().p("AgGA2IABgPIAAgvIgZAAIAAAfIABAPIgOAAIABgPIAAgfIgBgLIALAAIAbAAIAAgPIgFABIghABQgCgIgCgEIAHAAQAqgBAbgFIAMgDIAHANIgHABQgNADgVACIAAAPIAdAAIALAAIgBALIAAAgQABAOgRgBIgNAAQAAgHgDgGQAJACAGAAQAFAAgBgEIAAgeIgaAAIAAAvIAAAPg");
	this.shape_4.setTransform(29.6,33.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#D81E05").s().p("AAjAzQgMgBgOgQQgIgMgDgOIgdAAIAAAaIAegIIABANQgDAAgYAIIgSAEIgDgNQAEgBgBgGIAAhDIAAgOIAOABIA3AAIAOgBIgBAMIAAANIABALIgNgBIgTAAIACANIAYAAIANgBIAAAMIgNgBIgWAAQAFAMAIAJQAHAHAEAAQACABACgRQAFAEAHADQgEAYgKAAIgBAAgAgfgCIAbAAIgCgNIgZAAgAgfgaIA3AAIAAgMIg3AAg");
	this.shape_5.setTransform(18.3,33.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#D81E05").s().p("AAQAZQgLgNgFgSQgCAMgGALQgGAMgMALQgHAHgLAGQgEgHgFgFQAPgJALgKQAVgYAAgoIgBgKIAOAAIgBALQAAAbAMATQAHAMALAKQAJAIAKAFQgGAGgEAHQgTgNgKgPg");
	this.shape_6.setTransform(5.8,33.6);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#D81E05").s().p("");
	this.shape_7.setTransform(112.5,-5.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#D81E05").s().p("");
	this.shape_8.setTransform(66.7,-5.6);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#D81E05").s().p("");
	this.shape_9.setTransform(21,-5.3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0.1,-24.7,171.2,86.8);
...
(lib.yuding = function(mode,startPosition,loop) {
	...
	this.instance_1 = new lib.liswf("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(114.7,28.1,2.249,2.249,0,0,0,23.4,5.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#D81E05").ss(2,1,1).p("APkkBI/HAAQhHAAAABHIAAF0QAABIBHAAIfHAAQBHAAAAhIIAAl0QAAhHhHAAg");
	this.shape_4.setTransform(115.8,30.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#D81E05").s().p("AvjECQhHAAAAhHIAAl1QAAhHBHAAIfHAAQBHAAAABHIAAF1QAABHhHAAg");
	this.shape_5.setTransform(115.8,30.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.instance_1}]},1).wait(3));
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	// 图层 15
	this.instance = new lib.小标_1();
	this.instance.parent = this;
	this.instance.setTransform(141.5,582.7,1,1,0,0,0,4,8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).wait(1019));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(214).to({_off:false},0).to({alpha:1},6).wait(809));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(214).to({_off:false},0).to({alpha:1},6).wait(809));
	...
	// t2
	this.instance_4 = new lib.t2swf副本();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(12).to({_off:false},0).to({alpha:1},7).wait(48).to({startPosition:0},0).to({alpha:0},7).wait(955));
...
// library properties:
lib.properties = {
	id: '9230606ADE83466781CB03A5FDFCAED4',
	width: 160,
	height: 600,
	fps: 25,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/160x600_atlas_.png?1562687551846", id:"160x600_atlas_"}
	],
	preloads: []
};
...
an.compositions['9230606ADE83466781CB03A5FDFCAED4'] = {
