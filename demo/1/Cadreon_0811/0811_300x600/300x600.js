...
(lib.an = function(mode,startPosition,loop) {
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("A4qHQIAAufMAxVAAAIAAOfg");
	this.shape_10.setTransform(-125.4,4.8);
...
p.nominalBounds = new cjs.Rectangle(-289.6,-44,315.8,92.9);
...
(lib.t2swf = function(mode,startPosition,loop) {
	...
	// Layer_6
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#D81E05").s().p("");
	this.shape.setTransform(40.7,-11.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D81E05").s().p("");
	this.shape_1.setTransform(13,-11.3);
...
p.nominalBounds = new cjs.Rectangle(-2.5,-26.8,219.1,88.3);
...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(151).to({_off:false},0).to({alpha:1},8).wait(49).to({y:347.1},6).wait(815));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(5).to({_off:false},0).to({scaleY:0.87,y:512.8,alpha:1},6).wait(197).to({scaleY:1.3,y:470.5},6).wait(815));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regY:294.6,scaleX:1,scaleY:1,x:84,y:294.6},51,cjs.Ease.get(1)).wait(978));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(138.5,258.5,545.1,1090.1);
// library properties:
lib.properties = {
	id: 'A5C1DC88C2AD49F5BE3407CF5C4AA822',
	width: 300,
	height: 600,
	fps: 25,
	color: "#FFFFFF",
...
an.compositions['A5C1DC88C2AD49F5BE3407CF5C4AA822'] = {
