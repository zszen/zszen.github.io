...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_8.setTransform(96.7,543.9,1.002,1.002,0,0,0,79.5,13.6);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;
	new cjs.ButtonHelper(this.instance_8, 0, 1, 2, false, new lib.yuding(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(231).to({_off:false},0).wait(1).to({regX:79.6,regY:19.5,x:96.8,y:536.9,alpha:0.143},0).wait(1).to({y:524,alpha:0.286},0).wait(1).to({y:511.2,alpha:0.429},0).wait(1).to({y:498.3,alpha:0.571},0).wait(1).to({y:485.5,alpha:0.714},0).wait(1).to({y:472.6,alpha:0.857},0).wait(1).to({y:459.7,alpha:1},0).wait(104).to({_off:true},1).wait(232));
	...
	this.instance_13.setTransform(63.7,412.1,1.09,1.09,0,0,0,183,28.2);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(27).to({_off:false},0).wait(1).to({regX:218.9,regY:29.7,x:102.9,y:413.7,alpha:0.125},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.375},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.625},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.875},0).wait(1).to({alpha:1},0).wait(48).to({alpha:0.875},0).wait(1).to({alpha:0.75},0).wait(1).to({alpha:0.625},0).wait(1).to({alpha:0.5},0).wait(1).to({alpha:0.375},0).wait(1).to({alpha:0.25},0).wait(1).to({alpha:0.125},0).wait(1).to({alpha:0},0).to({_off:true},1).wait(484));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"img/bj.jpg?1574867250921", id:"sujet"}
	],
	preloads: []
};
