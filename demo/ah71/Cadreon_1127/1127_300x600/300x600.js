...
(lib._300x600 = function(mode,startPosition,loop) {
	...
	this.instance_8.setTransform(96.7,543.8,1.002,1.002,0,0,0,79.5,13.6);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;
	new cjs.ButtonHelper(this.instance_8, 0, 1, 2, false, new lib.yuding(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(231).to({_off:false},0).wait(1).to({regX:79.6,regY:19.5,x:96.8,y:536.8,alpha:0.143},0).wait(1).to({y:524,alpha:0.286},0).wait(1).to({y:511.1,alpha:0.429},0).wait(1).to({y:498.3,alpha:0.571},0).wait(1).to({y:485.4,alpha:0.714},0).wait(1).to({y:472.6,alpha:0.857},0).wait(1).to({y:459.7,alpha:1},0).wait(104).to({_off:true},1).wait(232));
