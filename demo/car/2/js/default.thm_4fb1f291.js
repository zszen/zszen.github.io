window.skins=window.skins||{};
	...
	function ui_roadSkin() {
		_super.call(this);
		this.skinParts = ["mov_road_def","mov_car1","mov_car2","mov_cloudy","mov_chest_def","mov_chest_wave","mov_chest_shake","ly_pots_planet","ly_cloudy","road","road_masker","sign3","sign4","sign5","sign6","sign7","sign8","ly_road_lines","fog","ly_pots_trap","fog_small","car","mcDetectTarget","txtCoinCount","ly_txtCoinCount","ly_car","p_start1","p_start2","p_start3","p_start4","p_start5","p_start6","p_end1","p_end2","p_end3","p_end4","p_end5","p_end6","p_end7","ly_pots","ly_animations","txt_distance","ly_top_simbols","txt_hp","ly_bottom_simbols","ly_blocks","ly_popboard","bt_d_water","bt_d_well","bt_d_hole","bt_d_ship","bt_d_whale","bt_d_coin","bt_d_chest1red","bt_d_popboard","bt_d_glassroad","ly_debug_btns"];
	...
	_proto.ly_debug_btns_i = function () {
		...
		t.width = 110.85;
		t.y = 0;
		t.elementsContent = [this.bt_d_water_i(),this.bt_d_well_i(),this.bt_d_hole_i(),this.bt_d_ship_i(),this.bt_d_whale_i(),this.bt_d_coin_i(),this.bt_d_chest1red_i(),this.bt_d_popboard_i(),this.bt_d_glassroad_i()];
		return t;
	};
