window.skins=window.skins||{};
	...
	function ui_roadSkin() {
		_super.call(this);
		this.skinParts = ["mov_road_def","mov_car1","mov_car2","mov_cloudy","mov_chest_def","mov_chest_wave","mov_chest_shake","ly_pots_planet","ly_cloudy","road","sign3","sign4","sign5","sign6","sign7","sign8","ly_road_lines","fog","ly_pots_trap","fog_small","car","mcDetectTarget","txtCoinCount","ly_txtCoinCount","ly_car","p_start1","p_start2","p_start3","p_start4","p_start5","p_end1","p_end2","p_end3","p_end4","p_end5","p_end6","p_end7","ly_pots","ly_animations","txt_distance","ly_top_simbols","txt_hp","ly_bottom_simbols","ly_blocks","ly_popboard","bt_d_water","bt_d_well","bt_d_hole","bt_d_ship","bt_d_whale","bt_d_coin","bt_d_chest1red","bt_d_popboard","ly_debug_btns"];
		...
		this.elementsContent = [this._Rect1_i(),this.ly_pots_planet_i(),this.ly_cloudy_i(),this.road_i(),this.ly_road_lines_i(),this.fog_i(),this.ly_pots_trap_i(),this.fog_small_i(),this.ly_car_i(),this.ly_pots_i(),this.ly_animations_i(),this.ly_top_simbols_i(),this.ly_bottom_simbols_i(),this.ly_blocks_i(),this.ly_popboard_i(),this.ly_debug_btns_i()];
	...
	_proto.ly_car_i = function () {
		...
		t.x = 330;
		t.y = 815;
		t.elementsContent = [this.car_i(),this.mcDetectTarget_i(),this.ly_txtCoinCount_i()];
		return t;
	};
	...
	_proto.ly_txtCoinCount_i = function () {
		...
		t.x = 19;
		t.y = 204;
		t.elementsContent = [this._Image14_i(),this.txtCoinCount_i()];
		return t;
	};
	...
	_proto.ly_pots_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.p_start1_i(),this.p_start2_i(),this.p_start3_i(),this.p_start4_i(),this.p_start5_i(),this.p_end1_i(),this.p_end2_i(),this.p_end3_i(),this.p_end4_i(),this.p_end5_i(),this.p_end6_i(),this.p_end7_i()];
		return t;
	};
	...
	_proto.ly_top_simbols_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image15_i(),this._Image16_i(),this.txt_distance_i()];
		return t;
	};
	...
	_proto.ly_debug_btns_i = function () {
		...
		t.width = 110.85;
		t.y = 0;
		t.elementsContent = [this.bt_d_water_i(),this.bt_d_well_i(),this.bt_d_hole_i(),this.bt_d_ship_i(),this.bt_d_whale_i(),this.bt_d_coin_i(),this.bt_d_chest1red_i(),this.bt_d_popboard_i()];
		return t;
	};
