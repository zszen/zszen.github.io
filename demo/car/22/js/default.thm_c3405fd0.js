window.skins=window.skins||{};
	...
	function ui_roadSkin() {
		_super.call(this);
		this.skinParts = ["mov_road_def","mov_car1","mov_car2","mov_cloudy","mov_chest_def","mov_chest_wave","mov_chest_shake","ly_pots_planet","ly_cloudy","road","road_masker","road_speed1","road_speed2","ly_road_speedup","sign3","sign4","sign5","sign6","sign7","sign8","ly_road_lines","fog","ly_pots_glassroad","ly_pots_trap","fog_small","car","mcAbsorbTarget","mcDetectTarget","txtCoinCount","ly_txtCoinCount","ly_car","p_start1","p_start2","p_start3","p_start4","p_start5","p_start6","p_end1","p_end2","p_end3","p_end4","p_end5","p_end6","p_end7","ly_pots","ly_fog","ly_animations","txt_hp","ly_bottom_simbols","txt_distance","ly_top_simbols","ly_blocks","ly_popboard","bt_d_close","bt_d_water","bt_d_well","bt_d_hole","bt_d_ship","bt_d_whale","bt_d_coin","bt_d_fog","bt_d_popboard","bt_d_glassroad","bt_d_infokm","bt_d_gameover","bt_d_chest1red","bt_d_chest2green","bt_d_chest3orange","bt_d_chest4yellow","bt_d_chest5blue","bt_d_chest6purple","bt_d_chest7tree","bt_d_chest8girl","bt_d_game","bt_d_share","bt_d_score","ly_debug_btns","txt_pop_km","tkm0","ly_pop_km","ly_board"];
