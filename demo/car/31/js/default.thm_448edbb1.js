window.skins=window.skins||{};
	...
	function board_helpSkin() {
		_super.call(this);
		this.skinParts = ["mov_sub1","title","bg1","car","info1","hand","bt_1_next","ly1","bg2","bt_2_prev","bt_2_next","info2","sub2_content","bt_sub2_next","bt_sub2_prev","ly2","bg3","info3","bt_3_prev","bt_3_startgame","ly3","ly_board","bt_skip"];
		...
		eui.Binding.$bindProperties(this, [212.5],[],this._Object1,"x");
		eui.Binding.$bindProperties(this, [349],[],this._Object1,"y");
		eui.Binding.$bindProperties(this, [347],[],this._Object2,"x");
		eui.Binding.$bindProperties(this, [353.5],[],this._Object2,"y");
		eui.Binding.$bindProperties(this, [285.36],[],this._Object3,"x");
		eui.Binding.$bindProperties(this, [354.52],[],this._Object3,"y");
		eui.Binding.$bindProperties(this, ["car"],[0],this._TweenItem2,"target");
		eui.Binding.$bindProperties(this, [129],[],this._Object4,"x");
		eui.Binding.$bindProperties(this, [273.06],[],this._Object4,"y");
		eui.Binding.$bindProperties(this, [408],[],this._Object5,"x");
		eui.Binding.$bindProperties(this, [273.06],[],this._Object5,"y");
		eui.Binding.$bindProperties(this, [261.5],[],this._Object6,"x");
	...
	_proto.ly_board_i = function () {
		...
		t.width = 620;
		t.y = 165;
		t.elementsContent = [this.title_i(),this.ly1_i(),this.ly2_i(),this.ly3_i()];
		return t;
	};
	_proto.title_i = function () {
		...
		this.title = t;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_title";
		t.top = -38;
		return t;
	};
	_proto.ly1_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.bg1_i(),this.car_i(),this.info1_i(),this._Image1_i(),this._Image2_i(),this.hand_i(),this.bt_1_next_i()];
		return t;
	};
	_proto.bg1_i = function () {
		...
		t.bottom = 50;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_1_bg";
		return t;
	};
	_proto.car_i = function () {
		...
		this.car = t;
		t.bottom = 50;
		t.source = "res03_json.board_help_1_car";
		t.x = 261;
		return t;
	};
	_proto.info1_i = function () {
		...
		this.info1 = t;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_1_txt";
		t.top = 44;
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
		t.bottom = 361.05999999999995;
		t.source = "res03_json.board_help_1_direct_1";
		t.x = 180;
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
		t.bottom = 361.05999999999995;
		t.source = "res03_json.board_help_1_direct_2";
		t.x = 384;
		return t;
	};
	_proto.hand_i = function () {
		var t = new eui.Image();
		this.hand = t;
		t.bottom = 344.05999999999995;
		t.source = "res03_json.board_help_1_direct_hand";
		t.x = 285;
		return t;
	};
	_proto.bt_1_next_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res03_json.board_help_bt_next";
		t.x = 80;
		t.y = 363.06;
		return t;
	};
	_proto.ly2_i = function () {
		...
		t.scaleY = 1;
		t.top = 0;
		t.elementsContent = [this.bg2_i(),this.bt_2_prev_i(),this.bt_2_next_i(),this.info2_i(),this.sub2_content_i(),this.bt_sub2_next_i(),this.bt_sub2_prev_i()];
		return t;
	};
	_proto.bg2_i = function () {
		...
		t.bottom = 50;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_2_bg";
		return t;
	};
	_proto.bt_2_prev_i = function () {
		...
		this.bt_2_prev = t;
		t.bottom = -72;
		t.source = "res03_json.board_help_bt_prev";
		t.x = 4;
		return t;
	};
	...
	_proto.info2_i = function () {
		...
		this.info2 = t;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_2_txt";
		t.top = 44;
		return t;
	};
	_proto.sub2_content_i = function () {
		...
		this.sub2_content = t;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_2_info_1";
		t.y = 289.56;
		return t;
	};
	_proto.bt_sub2_next_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res03_json.board_help_2_bt_next";
		t.x = 460.5;
		t.y = 577.06;
		return t;
	};
	_proto.bt_sub2_prev_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res03_json.board_help_2_bt_prev";
		t.x = 112;
		t.y = 577.06;
		return t;
	};
	_proto.ly3_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this.bg3_i(),this.info3_i(),this.bt_3_prev_i(),this.bt_3_startgame_i()];
		return t;
	};
	_proto.bg3_i = function () {
		...
		t.source = "res03_json.board_help_3_bg";
		return t;
	};
	_proto.info3_i = function () {
		...
		this.info3 = t;
		t.horizontalCenter = 0;
		t.source = "res03_json.board_help_3_txt";
		t.top = 44;
		return t;
	};
	_proto.bt_3_prev_i = function () {
		var t = new eui.Image();
		this.bt_3_prev = t;
		t.bottom = -72;
		t.source = "res03_json.board_help_bt_prev";
	...
	_proto.bt_3_startgame_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res03_json.board_help_3_bt_start";
		t.x = 298;
		return t;
	};
	_proto.bt_skip_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res03_json.board_help_bt_skip";
		t.top = 42;
		t.x = 520;
		t.y = 50;
		return t;
	...
	function ui_roadSkin() {
		...
		eui.Binding.$bindProperties(this, ["eff_orange_absort"],[0],this._TweenItem20,"target");
		eui.Binding.$bindProperties(this, [-111],[],this._Object47,"y");
	}
	...
	_proto.eff_orange_back_i = function () {
		...
		t.x = 106;
		t.y = 63;
		t.elementsContent = [this.eff_orange_absort_i(),this.eff_orange_absort_mask_i()];
		return t;
	};
	_proto.eff_orange_absort_i = function () {
		var t = new eui.Image();
		this.eff_orange_absort = t;
		t.anchorOffsetX = 0;
		t.scaleX = 1;
		t.scaleY = 1;
	...
	_proto.eff_orange_absort_mask_i = function () {
		var t = new eui.Image();
		this.eff_orange_absort_mask = t;
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "res01_json.eff_orange_absort_mask";
		t.x = -47;
		t.y = -126;
		return t;
	};
	...
	_proto.bt_d_chest9beatvirus_i = function () {
		var t = new eui.Button();
		this.bt_d_chest9beatvirus = t;
		t.label = "宝.关爱宝";
		t.x = 112;
		t.y = 446;
		return t;
	...
	_proto.bt_d_localstore_i = function () {
		var t = new eui.Button();
		this.bt_d_localstore = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 48;
		t.label = "JS save cls";
