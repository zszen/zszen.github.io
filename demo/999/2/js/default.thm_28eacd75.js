window.skins=window.skins||{};
	...
	function S_IndexSkin() {
		_super.call(this);
		this.skinParts = ["layer_bg","t1","masker","p6","p5","p4","p3","p2","p1","area","arrawToLeft","arrawHole","arrawHand","grp_arraw","c1","c2","c3","contents"];
		
		this.height = 1330;
		this.width = 750;
		this.elementsContent = [this.layer_bg_i(),this.contents_i(),this._Image2_i()];
	}
	var _proto = S_IndexSkin.prototype;

	_proto.layer_bg_i = function () {
		var t = new S_Major();
		this.layer_bg = t;
		t.bottom = 0;
		t.left = 0;
	...
	function S_MajorSkin() {
		...
		this.height = 1330;
		this.width = 750;
		this.elementsContent = [this._Layer_Bg1_i(),this.card0_i(),this.card1_i(),this.card5_i(),this.card2_i(),this.card4_i(),this.card3_i(),this._Image1_i()];
	}
	var _proto = S_MajorSkin.prototype;

	_proto._Layer_Bg1_i = function () {
		var t = new Layer_Bg();
		t.bottom = 0;
		t.left = 0;
		t.right = 0;
	...
	function S_P1Skin() {
		_super.call(this);
		this.skinParts = ["layer_bg","masker","t1","v1","p1","t2","contents"];
		
		this.height = 1330;
		this.width = 750;
		this.elementsContent = [this.layer_bg_i(),this.contents_i(),this._Layer_share1_i(),this._Image1_i()];
	}
	...
	_proto._Layer_share1_i = function () {
		var t = new Layer_share();
		t.bottom = 94;
		t.height = 146;
		t.left = 0;
		t.right = 0;
	...
	return S_P1Skin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/S_P1E.exml'] = window.S_P1ESkin = (function (_super) {
	__extends(S_P1ESkin, _super);
	function S_P1ESkin() {
		_super.call(this);
		this.skinParts = ["layer_bg","p1","h4","h3","h2","h1","hats","contents"];
		
		this.height = 1330;
		this.width = 750;
		this.elementsContent = [this.layer_bg_i(),this.contents_i(),this._Layer_share1_i(),this._Image5_i()];
	}
	var _proto = S_P1ESkin.prototype;
	...
	_proto.contents_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._Image1_i(),this._Image2_i(),this.p1_i(),this._Image3_i(),this._Image4_i(),this.hats_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto.hats_i = function () {
		...
		t.x = 384;
		t.y = 648;
		t.elementsContent = [this.h4_i(),this.h3_i(),this.h2_i(),this.h1_i()];
		return t;
	};
	_proto.h4_i = function () {
		var t = new eui.Image();
		this.h4 = t;
		t.scaleX = -1;
		t.scaleY = 1;
