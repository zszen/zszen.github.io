window.skins=window.skins||{};
	...
	function S_MajorSkin() {
		_super.call(this);
		this.skinParts = ["card_bg0","card_color0","card0","card_bg1","card_color1","card1","card_bg5","card_color5","card5","card_bg2","card_color2","card2","card_bg4","card_color4","card4","card_bg3","card_color3","video_frame","card3"];
	...
	_proto.card3_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 640;
		t.elementsContent = [this.card_bg3_i(),this.card_color3_i(),this.video_frame_i()];
		return t;
	};
	...
	function S_P1Skin() {
		_super.call(this);
		this.skinParts = ["bg","t1","v1","t2","p1","masker","contents","bt_gift0","bt_share0","buttons"];
	...
	_proto.contents_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.t1_i(),this.v1_i(),this.t2_i(),this.p1_i(),this.masker_i()];
		return t;
	};
	_proto.t1_i = function () {
		var t = new eui.Image();
